...
namespace Raccoons.Scores.Banks
{
    public class DefaultScoreBank : IScoreBank, IDisposable
    {
        ...
        public ScoreMetadata Metadata { get; private set; }
        ...
        private ScoreAcquisitionData NotifyScoreAcquired(float amount, float newScoreAcquisition,
            ScoreChangeData changeData)
        {
